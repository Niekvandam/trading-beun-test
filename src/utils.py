...
def precompute_data(
    ...
    for k_period in stoch_k_periods:
        for d_period in stoch_d_periods:
            ...
            new_columns[f'stoch_k_{k_period}_{d_period}'] = k_values
            new_columns[f'stoch_d_{k_period}_{d_period}'] = d_values
    ...
    for macd_fast in macd_fast_periods:
        for macd_slow in macd_slow_periods:
            ...
            for macd_signal in macd_signal_periods:
                ...
                new_columns[f'macd_line_{macd_fast}_{macd_slow}_{macd_signal}'] = macd_line
                new_columns[f'signal_line_{macd_fast}_{macd_slow}_{macd_signal}'] = signal_line
